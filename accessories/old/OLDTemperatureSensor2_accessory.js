...
//    console.log("Getting the current temperature!");
    PythonShell.run("/accessories/python/temphum_plc.py", {
    	args: ['temp',device]
...
var sensorUUID = uuid.generate('hap-nodejs:accessories:temperature-sensor2');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake lock.
var sensor = exports.accessory = new Accessory('Roof Temperature', sensorUUID);
...
sensor
  ...
  .setCharacteristic(Characteristic.SerialNumber, "TEMP2");
